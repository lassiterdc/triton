...
static void addSystemInflows(DateTime currentDate, double routingStep, double *exchange_q); //TRITON
static void addExternalInflows(DateTime currentDate, double *exchange_q); //TRITON
...
//
{
    ...
    if (BetweenEvents == FALSE)
    {
        ...
        addSystemInflows(currentDate, routingStep, exchange_q); //TRITON
...
void  addSystemInflows(DateTime currentDate, double routingStep, double *exchange_q) //TRITON
{
    int j;
    ...
    addExternalInflows(currentDate, exchange_q); //TRITON
...
void addExternalInflows(DateTime currentDate, double *exchange_q) //TRITON
//
